...
const DragAndDrop = ({setContent,content,error,setError,sharePost}) => {
    ...
    //   const upladedImages=[...images,e.target.files[0]];
    //   setImages(upladedImages)
    //   console.log(images)
    // }
  ...
  return (
   <> 
    <div className="upload_container">
      ...
      {!error && content && <img className='upload_container-image' src={imageUrl} alt="kuch"></img> }
      {!content &&
        <>
      ...
      <input type="file" className="upload_container-input" id="uploadpost" onChange={handleChange} />
      <label className='btn btn-blue upload_container-label' htmlFor="uploadpost">Select from PC</label>
        </>
      }
